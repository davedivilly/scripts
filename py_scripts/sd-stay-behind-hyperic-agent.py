...
print "---------------------------------------------------------------------------------------------------"
print "To use this script type: fab -f sd-stay-behind-hyperic-agent.py -p <YourQUALPASS> hosts agent_setup"
print "---------------------------------------------------------------------------------------------------"
...
def hosts():
    env.hosts = open('/usr2/ddivilly/SCRIPTS/PYTHON/sd-stay-behind.txt', 'r').readlines()
